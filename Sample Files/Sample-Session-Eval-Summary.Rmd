...
subtitle: "Session: Certification Standards, Department Responsibilities, and Adoption Applications" 
author: "Trainer: ODHS Presenters"
date: "Date: September 8, 2021, February 16, 2022, July 6, 2022, and February 2, 2023"
...
```{r, include=FALSE}
number_registered <- ca_registered %>% 
  filter(cohort == params$cohort) %>% 
  pull(registered)
```
